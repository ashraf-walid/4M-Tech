    ...
    >
      ...
      <div className="relative bg-sky-900 text-white py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-sky-100 max-w-2xl mx-auto">
            نحن هنا للإجابة على استفساراتك ومساعدتك في كل ما تحتاج إليه.
          </p>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg
            className="w-full h-12 text-sky-50 fill-current"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 mb-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 transform hover:-translate-y-1 transition duration-300">
            ...
            <p className="text-gray-600 dir-ltr">01149005161</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 transform hover:-translate-y-1 transition duration-300">
            ...
            <p className="text-gray-600">support@hilalcomputer.com</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 transform hover:shadow-2xl transition duration-300">
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                يسعدنا استقبال رسالتك والإجابة على استفساراتك.
              </p>
            </div>
            <ContactForm />
          </div>
          ...
          <div className="bg-gradient-to-br from-sky-50 to-white rounded-2xl shadow-xl p-8 transform hover:shadow-2xl transition duration-300">
            <ContactInfo />
          </div>
        </div>
      </div>
      ...
      <div className="h-96 w-full relative overflow-hidden">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d212.81689158964326!2d31.811187342483912!3d31.412190095902442!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14f9ef87549cd7c7%3A0xb9e59eb736d1ef7b!2z2YfZhNin2YQg2YPZhdio2YrZiNiq2LE!5e0!3m2!1sar!2seg!4v1754934926142!5m2!1sar!2seg"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen=""
