...
export default function Contact() {
    return (
        <>
        <Header/>
        <div className="min-h-screen bg-gradient-to-b from-sky-50 to-white max-sm:mt-4 mt-6" dir="rtl">
            {/* Hero Section */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10 mb-16">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6 transform hover:-translate-y-1 transition duration-300">
                        ...
                        <p className="text-gray-600">مول الحمد، دمياط الجديدة</p>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 transform hover:shadow-2xl transition duration-300">
                        <div className="mb-8">
                            ...
                            <p className="text-gray-600">يسعدنا استقبال رسالتك والإجابة على استفساراتك.</p>
                        </div>
                        <ContactForm />
                    </div>
