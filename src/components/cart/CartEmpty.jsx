...
const suggestedCategories = [
  { name: 'أجهزة اللابتوب', path: '/Laptops', icon: Laptop },
  { name: 'الإكسسوارات', path: '/Accessories', icon: Headphones },
];
    ...
    <div className="min-h-[90vh] flex flex-col items-center justify-center bg-gradient-to-b from-gray-50 to-white px-4">
      ...
      <div className="text-center max-w-md mx-auto">
        ...
        <p className="text-gray-600 text-lg mb-8">
          لم تقم بإضافة أي منتجات إلى السلة بعد. تصفح مجموعاتنا واختر ما يناسبك!
        </p>
