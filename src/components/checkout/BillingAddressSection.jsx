...
const billingFields = [
  { name: 'billingAddress', label: 'عنوان الشارع', type: 'textarea' },
  { name: 'billingCity', label: 'المدينة', type: 'text' },
  { name: 'billingState', label: 'المحافظة', type: 'text' }
];
