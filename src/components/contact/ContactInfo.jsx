    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        <div className="flex items-start space-x-4 space-x-reverse group">
          ...
          <div>
            <h3 className="font-medium text-gray-900 group-hover:text-sky-600 transition-colors duration-150">العنوان</h3>
            <p className="text-gray-600 mt-1">دمياط الجديدة</p>
            <p className="text-gray-600">مول الحمد</p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-4 space-x-reverse group">
          ...
          <div>
            <h3 className="font-medium text-gray-900 group-hover:text-sky-600 transition-colors duration-150">الهاتف</h3>
            <a
        ...
        {/* <div className="flex items-start space-x-4 space-x-reverse group">
          ...
          <div>
            <h3 className="font-medium text-gray-900 group-hover:text-sky-600 transition-colors duration-150">البريد الإلكتروني</h3>
            <a
              href="mailto:support@2MTechnology.com"
              className="text-gray-600 hover:text-sky-500 transition-colors duration-150 mt-1 block"
              dir="ltr"
            >
              support@2MTechnology.com
            </a>
          </div>
        </div> */}
        ...
        <div className="flex items-start space-x-4 space-x-reverse group">
          ...
          <div>
            <h3 className="font-medium text-gray-900 group-hover:text-sky-600 transition-colors duration-150">ساعات العمل</h3>
            <div className="space-y-2 text-gray-600 mt-1">
              <p>الأحد - الخميس: 10:00 صباحًا - 10:00 مساءً</p>
      ...
      <div className="pt-6 border-t border-gray-200">
        <h3 className="font-medium text-gray-900 mb-4">تابعنا على</h3>
        <div className="flex gap-4 space-x-reverse">
          ...
          <a
            ...
            className="gap-1.5 text-gray-200 hover:text-[#25D366] transition-colors duration-300"
          >
            <WhatsAppIcon className="w-6 h-6 text-gray-400 hover:text-sky-500" />
          </a>
          ...
          <Link
            ...
            rel="noopener noreferrer"
          >
            <TikTokIcon className="w-5 h-5 text-gray-400 hover:text-sky-500" />
          </Link>
