...
import { laptopsAll } from "@/products/laptops";
import { GraphicsCards } from "@/products/Cards";
import { desktopPCs } from "@/products/Desktop";
import { GamingPCs } from "@/products/Desktop";
...
export default function SearchComponent() {
  ...
  return (
    <>
      <div className="relative flex-1 mx-2 md:mx-4 max-w-xl" ref={searchRef}>
        <AnimatedBorder isActive={isFocused}>
          <div className="relative">
            <input
              ...
              className="w-full py-2.5 pr-2 md:pr-4 text-base rounded-full focus:outline-none bg-gray-50 text-right transition-all duration-300"
            />
            <Search
              size={22}
              cursor="pointer"
